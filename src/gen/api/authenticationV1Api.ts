...
export class AuthenticationV1Api {
     ...
     */
    public async createAuthenticationV1TokenReview (body: IoK8sApiAuthenticationV1TokenReview, dryRun?: string, fieldManager?: string, pretty?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApiAuthenticationV1TokenReview;  }> {
