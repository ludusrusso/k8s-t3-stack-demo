...
*/
export class ComGoogleCloudCnrmBigqueryV1beta1BigQueryJobSpecCopyDestinationTable {
    ...
    static getAttributeTypeMap() {
        return ComGoogleCloudCnrmBigqueryV1beta1BigQueryJobSpecCopyDestinationTable.attributeTypeMap;
    }
}
