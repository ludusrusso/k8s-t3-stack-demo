...
*/
export class IoFluxcdToolkitHelmV2beta1HelmReleaseSpecKubeConfigSecretRef {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return IoFluxcdToolkitHelmV2beta1HelmReleaseSpecKubeConfigSecretRef.attributeTypeMap;
    }
}
