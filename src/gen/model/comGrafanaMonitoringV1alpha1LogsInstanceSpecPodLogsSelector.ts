...
*/
export class ComGrafanaMonitoringV1alpha1LogsInstanceSpecPodLogsSelector {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return ComGrafanaMonitoringV1alpha1LogsInstanceSpecPodLogsSelector.attributeTypeMap;
    }
}
