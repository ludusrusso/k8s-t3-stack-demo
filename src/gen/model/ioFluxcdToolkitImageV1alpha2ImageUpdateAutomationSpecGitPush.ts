...
*/
export class IoFluxcdToolkitImageV1alpha2ImageUpdateAutomationSpecGitPush {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return IoFluxcdToolkitImageV1alpha2ImageUpdateAutomationSpecGitPush.attributeTypeMap;
    }
}
