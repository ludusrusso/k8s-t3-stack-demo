...
*/
export class ComGrafanaMonitoringV1alpha1MetricsInstanceSpecProbeSelector {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return ComGrafanaMonitoringV1alpha1MetricsInstanceSpecProbeSelector.attributeTypeMap;
    }
}
