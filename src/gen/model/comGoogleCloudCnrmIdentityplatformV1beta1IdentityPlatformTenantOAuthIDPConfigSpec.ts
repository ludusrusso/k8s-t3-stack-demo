...
import { ComGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpecTenantRef } from './comGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpecTenantRef';

export class ComGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpec {
    /**
    ...
    */
    ...
    'tenantRef': ComGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpecTenantRef;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "tenantRef",
            "baseName": "tenantRef",
            "type": "ComGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpecTenantRef"
        }    ];

    static getAttributeTypeMap() {
        return ComGoogleCloudCnrmIdentityplatformV1beta1IdentityPlatformTenantOAuthIDPConfigSpec.attributeTypeMap;
    }
}
