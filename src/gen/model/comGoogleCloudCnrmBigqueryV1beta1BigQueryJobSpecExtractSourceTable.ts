...
*/
export class ComGoogleCloudCnrmBigqueryV1beta1BigQueryJobSpecExtractSourceTable {
    ...
    static getAttributeTypeMap() {
        return ComGoogleCloudCnrmBigqueryV1beta1BigQueryJobSpecExtractSourceTable.attributeTypeMap;
    }
}
