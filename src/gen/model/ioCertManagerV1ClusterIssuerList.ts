...
*/
export class IoCertManagerV1ClusterIssuerList {
    /**
    ...
    */
    'items': Array<IoCertManagerV1ClusterIssuer>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoCertManagerV1ClusterIssuer>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoCertManagerV1ClusterIssuerList.attributeTypeMap;
    }
}
