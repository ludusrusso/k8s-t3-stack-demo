...
*/
export class IoCertManagerAcmeV1ChallengeList {
    /**
    ...
    */
    'items': Array<IoCertManagerAcmeV1Challenge>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoCertManagerAcmeV1Challenge>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoCertManagerAcmeV1ChallengeList.attributeTypeMap;
    }
}
