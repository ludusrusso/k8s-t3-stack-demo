...
*/
export class IoCertManagerV1CertificateList {
    /**
    ...
    */
    'items': Array<IoCertManagerV1Certificate>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoCertManagerV1Certificate>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoCertManagerV1CertificateList.attributeTypeMap;
    }
}
