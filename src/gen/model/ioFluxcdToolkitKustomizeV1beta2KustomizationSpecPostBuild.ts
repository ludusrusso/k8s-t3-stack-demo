...
import { IoFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuildSubstituteFromInner } from './ioFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuildSubstituteFromInner';

/**
* PostBuild describes which actions to perform on the YAML manifest generated by building the kustomize overlay.
*/
export class IoFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuild {
    /**
    ...
    */
    'substituteFrom'?: Array<IoFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuildSubstituteFromInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Array<IoFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuildSubstituteFromInner>"
        }    ];

    static getAttributeTypeMap() {
        return IoFluxcdToolkitKustomizeV1beta2KustomizationSpecPostBuild.attributeTypeMap;
    }
}
