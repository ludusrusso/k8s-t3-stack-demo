...
*/
export class ComCoreosMonitoringV1PodMonitorSpecPodMetricsEndpointsInnerOauth2ClientId {
    ...
    static getAttributeTypeMap() {
        return ComCoreosMonitoringV1PodMonitorSpecPodMetricsEndpointsInnerOauth2ClientId.attributeTypeMap;
    }
}
