...
*/
export class IoCertManagerAcmeV1OrderList {
    /**
    ...
    */
    'items': Array<IoCertManagerAcmeV1Order>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoCertManagerAcmeV1Order>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoCertManagerAcmeV1OrderList.attributeTypeMap;
    }
}
