...
export class ComGoogleCloudCnrmComputeV1beta1ComputeNetworkPeeringStatus {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "stateDetails",
            "baseName": "stateDetails",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return ComGoogleCloudCnrmComputeV1beta1ComputeNetworkPeeringStatus.attributeTypeMap;
    }
}
