...
import { IoFluxcdToolkitSourceV1beta2HelmRepositoryStatusArtifact } from './ioFluxcdToolkitSourceV1beta2HelmRepositoryStatusArtifact';

/**
* HelmRepositoryStatus records the observed state of the HelmRepository.
*/
export class IoFluxcdToolkitSourceV1beta2HelmRepositoryStatus {
    'artifact'?: IoFluxcdToolkitSourceV1beta2HelmRepositoryStatusArtifact;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "artifact",
            "baseName": "artifact",
            "type": "IoFluxcdToolkitSourceV1beta2HelmRepositoryStatusArtifact"
        },
        {
            "name": "conditions",
            "baseName": "conditions",
    ...
    static getAttributeTypeMap() {
        return IoFluxcdToolkitSourceV1beta2HelmRepositoryStatus.attributeTypeMap;
    }
}
