...
*/
export class ComGoogleCloudCnrmCloudschedulerV1beta1CloudSchedulerJobSpecRetryConfig {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "maxBackoffDuration",
            "type": "string"
        },
        {
            "name": "maxDoublings",
            "baseName": "maxDoublings",
            "type": "number"
        },
        {
            "name": "maxRetryDuration",
            "baseName": "maxRetryDuration",
            "type": "string"
        },
        {
            "name": "minBackoffDuration",
            "baseName": "minBackoffDuration",
            "type": "string"
        },
        {
            "name": "retryCount",
    ...
    static getAttributeTypeMap() {
        return ComGoogleCloudCnrmCloudschedulerV1beta1CloudSchedulerJobSpecRetryConfig.attributeTypeMap;
    }
}
