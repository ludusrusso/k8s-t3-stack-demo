...
*/
export class IoCertManagerV1CertificateRequestList {
    /**
    ...
    */
    'items': Array<IoCertManagerV1CertificateRequest>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<IoCertManagerV1CertificateRequest>"
        },
        {
            "name": "kind",
            "baseName": "kind",
    ...
    static getAttributeTypeMap() {
        return IoCertManagerV1CertificateRequestList.attributeTypeMap;
    }
}
